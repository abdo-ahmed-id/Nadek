class public_video {
  ...
  public_video({this.status, this.errNum, this.msg, this.data});

  factory public_video.fromJson(Map<String, dynamic>? json) {
...
/////https://flutterhq.com/questions-and-answers/1764/dart-map-type-string-is-not-a-subtype-of-type-int-of-index

...
import 'package:nadek/presentation/screen/PublicAllVideo.dart';
import 'package:nadek/presentation/screen/repprt_screen.dart';
import 'package:nadek/sheard/component/HeaderHomePage.dart';
...
class _home_pageState extends State<home_page> {
  ...
  void initState() {
    ...
    _cubit = NadekCubit.get(context);
    _cubit.getPublicVideo(token);

    _cubit.getPrivateVideo(token);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NadekCubit, NadekState>(
      ...
      listener: (context, state) {
        if (state is LoadedPrivateVideo) {
          setState(() {
            waiting = true;
            private = state.video;
              ...
              children: [
                ...
                PageView(
                  ...
                  children: [
                    ...
                    PublicAllVideo(p: private),
                    Layout(p: public),

                  ],
                  onPageChanged: (index) {
                    _cubit.ChangePageView();
                      ...
                      children: [
                        ...
                        IconButton(
                          style: ButtonStyle(
                            ...
                            onPressed: (){
                              Navigator.pushNamed(context, '/LiveUserNow');
                              BlocProvider.of<NadekCubit>(context).ChangePageView();

                            },
                            icon: Image.asset('assets/icons/live-streaming.png')
                        ),
                        IconButton(
                            onPressed: (){
                              Navigator.pushNamed(context, '/BestUsers');
                              BlocProvider.of<NadekCubit>(context).ChangePageView();
                            },
                            icon: Image.asset('assets/icons/ic_best_user.png')
                        ),
                      ],
                    ),
                  ),
...
class Layout extends StatefulWidget {
  ...
  Layout({Key? key, required this.p}) : super(key: key);
            ...
            child:  RotatedBox(
              ...
              child: TabBarView(
                ...
                children: [
                  ...
                  // for(int s =i;s>widget.p!.data![i].comments!.length;s++)
                    VideoPlayerItem(
                      ...
                      addrepprt: (){
                        ...
                        Navigator.push(widgetContext, MaterialPageRoute(
                            builder: (context)=>new repprt_screen(title: 'ابلاغ عن محتوي')
                        ));
                      },
                      addFollow: (){
                        addFollow(i);
